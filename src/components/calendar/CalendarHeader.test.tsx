...
describe("CalendarHeader", () => {
  ...
  describe("Title Formatting - Month View", () => {
    ...
    it("should capitalize month name", () => {
      ...
      const { container } = render(<CalendarHeader {...defaultProps} currentDate={date} viewMode="month" />);
  ...
  describe("getWeekNumber - Edge Cases", () => {
    ...
    it("should handle same week number for consecutive days in same week", () => {
      ...
      const { rerender } = render(<CalendarHeader {...defaultProps} currentDate={monday} viewMode="week" />);
  ...
  describe("Button Callbacks - View Mode Toggle", () => {
    ...
    it('should call onViewModeChange with "month" when month button clicked', async () => {
      ...
      render(<CalendarHeader {...defaultProps} viewMode="week" onViewModeChange={onViewModeChange} />);
  ...
  describe("Dynamic Title Updates", () => {
    it("should update title when currentDate changes in month view", () => {
      ...
      rerender(<CalendarHeader {...defaultProps} currentDate={new Date(2024, 5, 15)} viewMode="month" />);
    ...
    it("should update title when currentDate changes in week view", () => {
      ...
      rerender(<CalendarHeader {...defaultProps} currentDate={new Date(2024, 0, 22)} viewMode="week" />);
    ...
    it("should update title format when viewMode changes", () => {
      const date = new Date(2024, 0, 15);
      const { rerender } = render(<CalendarHeader {...defaultProps} currentDate={date} viewMode="month" />);
